...
def _build_async_url(raw_url: str) -> str:
    """Neon's connection string targets libpq (sslmode=..., channel_binding=...),
    which asyncpg doesn't understand as query params. Strip them and rely on
    connect_args={"ssl": True} instead, since Neon requires TLS regardless."""
